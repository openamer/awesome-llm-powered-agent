...
* ![OpenAmer Stars](https://img.shields.io/github/stars/openamer/openamer) [OpenAmer](https://github.com/openamer/openamer) - A self-improving Windows agent with real desktop control, persistent vector memory and an A2A mesh for peer-to-peer task routing.
